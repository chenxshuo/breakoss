...
# logs_bash/seed/seed-16-cot_bypass-gpt-oss-20b-StrongReject.log
SEED=16
CUDA_VISIBLE_DEVICES=0 nohup python examples/1_cot_bypass.py main_inference \
  --batch_size=32 \
  --seed=$SEED \
  --dataset_name=StrongReject \
  --model_name=openai/gpt-oss-20b > logs_bash/seed/seed-$SEED-cot_bypass-gpt-oss-20b-StrongReject.log 2>&1 &

CUDA_VISIBLE_DEVICES=1 nohup python examples/1_cot_bypass.py main_inference \
  --batch_size=32 \
  --dataset_name=HarmfulBehaviors \
  --seed=$SEED \
  --model_name=openai/gpt-oss-20b > logs_bash/seed/seed-$SEED-cot_bypass-gpt-oss-20b-HarmfulBehaviors.log 2>&1 &
...
CUDA_VISIBLE_DEVICES=2 nohup python examples/1_cot_bypass.py main_inference \
  ...
  --seed=$SEED \
  --model_name=openai/gpt-oss-20b > logs_bash/seed/seed-$SEED-cot_bypass-gpt-oss-20b-HarmBench.log 2>&1 &
...
CUDA_VISIBLE_DEVICES=3 nohup python examples/1_cot_bypass.py main_inference \
  ...
  --dataset_name=CatQA \
  --seed=$SEED \
  --model_name=openai/gpt-oss-20b > logs_bash/seed/seed-$SEED-cot_bypass-gpt-oss-20b-CatQA.log 2>&1 &
pids+=($!)
for ((i=${#pids[@]}; i>0; i--)) ; do
    wait -n
done
...
CUDA_VISIBLE_DEVICES=3 nohup python examples/1_cot_bypass.py main_inference \
  ...
  --model_name=openai/gpt-oss-20b > logs_bash/seed/seed-$SEED-cot_bypass-gpt-oss-20b-CaJBBHarmfulBehaviorstQA.log 2>&1 &

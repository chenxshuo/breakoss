...
#  --model_name=openai/gpt-oss-20b > logs_bash/direct-gpt-oss-20b-StrongReject.log 2>&1 &

#nohup python examples/0_direct.py main_inference \
#  --dataset_name=HarmfulBehaviors \
#  --model_name=openai/gpt-oss-20b > logs_bash/direct-gpt-oss-20b-HarmfulBehaviors.log 2>&1 &

#nohup python examples/0_direct.py main_inference \
#  --dataset_name=HarmBench \
#  --model_name=openai/gpt-oss-20b > logs_bash/direct-gpt-oss-20b-HarmBench.log 2>&1 &

# nohup python examples/0_direct.py main_inference \
#  --dataset_name=CatQA \
#  --model_name=openai/gpt-oss-20b > logs_bash/direct-gpt-oss-20b-CatQA.log 2>&1 &
#
# nohup python examples/0_direct.py main_inference \
#  --dataset_name=JBBHarmfulBehaviors \
#  --model_name=openai/gpt-oss-20b > logs_bash/direct-gpt-oss-20b-CaJBBHarmfulBehaviorstQA.log 2>&1 &
#
## gpt-oss-120b

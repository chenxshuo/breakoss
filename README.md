...
The `breakoss` command line tool is automatically installed. It can be used from
...
appreciated. See
[CONTRIBUTING.md](https://github.com//breakoss/blob/master/.github/CONTRIBUTING.md)

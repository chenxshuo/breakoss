...
```bash
python example/2_fake_overrefusal.py one_example
```
...
[GitHub Action](https://github.com//breakoss/actions?query=workflow%3ATests).
...
https://zenodo.org/account/settings/github/repository//breakoss to see the DOI
...
1. Uses [bump-my-version](https://github.com/callowayproject/bump-my-version) to
   ...
   `src/breakoss/version.py`, and [`docs/source/conf.py`](docs/source/conf.py)
...
1. Navigate to https://github.com//breakoss/releases/new to draft a new release
